// src/app/unit/rumah-bangunjiwo-bantul/page.tsx
"use client";
...
const DATA = {
  ...
  gallery: [
    {
      src: "/assets/images/bangunjiwo/1.jpg",
      label: "Desain Rumah Titik Huni Bangunjiwo",
    },
    {
      src: "/assets/images/bangunjiwo/2.jpg",
      label: "Foto Rumah Titik Huni Bangunjiwo dari Samping",
    },
    {
      src: "/assets/images/bangunjiwo/3.jpg",
      label: "Dinding Tekstur Dinding Kamprot Taman",
    },
    {
      src: "/assets/images/bangunjiwo/4.jpg",
      label: "Area Rumah dengan Pencahayaan Alami Optimal",
    },
    { src: "/assets/images/bangunjiwo/5.jpg", 
      label: "Batu Split dan Rumput Gajah Mini di Taman",
    },
    { src: "/assets/images/bangunjiwo/6.jpg", 
      label: "Kamar Tidur dengan Pencahayaan Terang",
    },
    { src: "/assets/images/bangunjiwo/7.jpg", 
      label: "Rumah dengan Desain Tropis Modern di Bantul",
    },
  ],
  specs: { land: "107m²", building: "50m²", beds: 2, baths: 1 },
  price: "575 Juta",
  priceNumeric: 575000000,
...
export default function BangunjiwoPage() {
  ...
  const jsonLd = {
    ...
    name: `${DATA.name} - Rumah Dijual di Bantul Yogyakarta`,
          ...
          <div className="flex-1 overflow-y-auto lg:overflow-hidden px-6 py-10 md:px-12 lg:px-16">
            <header className="mb-8">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold tracking-tighter leading-none mb-4">
                Titik Huni <br />{" "}
                <span className="text-neutral-300">Bangunjiwo</span>
              </h1>
