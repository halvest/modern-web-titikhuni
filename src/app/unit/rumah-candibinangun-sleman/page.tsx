// src/app/unit/rumah-candibinangun-sleman/page.tsx
"use client";
...
// Data SEO & Konten
const DATA = {
  name: "Titik Huni Candibinangun",
  slug: "rumah-candibinangun-sleman",
  location: "Candibinangun, Sleman, Yogyakarta",
  description:
    "Menghadirkan harmoni antara material jujur dan alam Sleman yang asri. Hunian modern tropis di Yogyakarta ini dirancang untuk ketenangan hidup maksimal dengan sirkulasi udara optimal dan pencahayaan alami.",
  gallery: [
    {
      src: "/assets/images/candibinangun/1.jpg",
      label: "Desain Rumah Titik Huni Candibinangun",
    },
    {
      src: "/assets/images/candibinangun/2.jpg",
      label: "Foto Rumah Titik Huni Candibinangun dari Samping",
    },
    {
      src: "/assets/images/candibinangun/3.jpg",
      label: "Dinding Tekstur Dinding Kamprot Taman",
    },
    {
      src: "/assets/images/candibinangun/4.jpg",
      label: "Area Rumah dengan Pencahayaan Alami Optimal",
    },
    {
      src: "/assets/images/candibinangun/5.jpg",
      label: "Batu Split dan Rumput Gajah Mini di Taman",
    },
    {
      src: "/assets/images/candibinangun/6.jpg",
      label: "Kamar Tidur dengan Pencahayaan Terang",
    },
    {
      src: "/assets/images/candibinangun/7.jpg",
      label: "Rumah dengan Desain Tropis Modern di Sleman",
    },
  ],
  specs: { land: "145m²", building: "50m²", beds: 2, baths: 1 },
  price: "740 Juta",
  priceNumeric: 740000000,
  waLink: "https://wa.me/6285190800168",
};

export default function CandibinangunPage() {
  ...
  const jsonLd = {
    ...
    name: `${DATA.name} - Rumah Dijual di Sleman Yogyakarta`,
