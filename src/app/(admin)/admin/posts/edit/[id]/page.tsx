...
import { updatePost } from "../../action"; // Pastikan path action.ts benar
  ...
  const editor = useEditor({
    extensions: [
      ...
      Placeholder.configure({
        placeholder: "Lanjutkan menulis konten Anda...",
      }),
    ],
    content: "",
  ...
  useEffect(() => {
    const init = async () => {
      try {
        ...
        // Fetch Data Post yang akan diedit
  ...
  if (fetching)
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-white">
        <Loader2 className="animate-spin text-neutral-200 mb-4" size={40} />
    ...
    <div className="bg-white min-h-screen pb-20">
      ...
      <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-neutral-100 px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <div
            className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest ${formData.status === "published" ? "bg-emerald-50 text-emerald-600" : "bg-amber-50 text-amber-600"}`}
          >
            {formData.status}
          </div>
          <button
      ...
      >
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          {/* TipTap Toolbar */}
          <div className="flex flex-wrap items-center gap-1.5 p-1 bg-neutral-50 rounded-2xl w-fit border border-neutral-100 sticky top-24 z-20 shadow-sm">
            <ToolbarButton
          ...
          <div className="bg-white rounded-[40px] border border-neutral-100 overflow-hidden shadow-2xl shadow-neutral-100/50">
        ...
        <div className="lg:col-span-4 space-y-10">
          <section className="space-y-4">
            ...
            <div className="relative aspect-square rounded-[32px] overflow-hidden bg-neutral-50 border-2 border-dashed border-neutral-100 group hover:border-black transition-all">
          ...
          <div className="bg-white w-full max-w-sm rounded-[40px] p-10 shadow-2xl animate-in zoom-in duration-300">
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-xl font-black uppercase tracking-tighter">
                New <span className="text-neutral-300">Category</span>
              </h2>
